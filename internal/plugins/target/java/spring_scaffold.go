...
const anvilManifestJSON = `{
  ...
  "language": "java",
  "compile": [
    { "cmd": "./mvnw", "args": ["compile", "-q"] }
  ],
  "test": [
    { "cmd": "./mvnw", "args": ["test", "-q"] }
  ],
  "run_fixture": { "cmd": "java", "args": ["-cp", "target/classes", "com.anvil.generated.AnvilRunner"] }
}
`

// mvnwScript is a portable Maven wrapper shell script (Unix).
const mvnwScript = `#!/bin/sh
# Maven Wrapper — generated by Anvil
set -e
...
// mvnwCmdScript is the Maven wrapper batch script (Windows).
const mvnwCmdScript = `@echo off
rem Maven Wrapper — generated by Anvil
