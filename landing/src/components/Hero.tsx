...
export default function Hero() {
  return (
    <section
      className="flex flex-col items-center gap-10 px-[120px] pt-[100px] pb-20 transition-colors"
    ...
    >
      ...
      <motion.h1 initial="hidden" animate="visible" custom={1} variants={fadeUp}
        className="text-[72px] font-extrabold leading-[1.05] text-center max-w-[900px]"
      ...
      <motion.p initial="hidden" animate="visible" custom={2} variants={fadeUp}
        className="font-mono text-base text-center max-w-[700px] leading-relaxed"
      ...
      <motion.div initial="hidden" animate="visible" custom={3} variants={fadeUp} className="flex gap-4">
        <a href="#demo" className="flex items-center gap-2.5 bg-[var(--color-accent)] text-black font-mono text-sm font-semibold px-7 py-3.5 hover:brightness-110 transition">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.6 }}
        className="flex w-full max-w-[1000px] mt-4"
      >
        <div className="flex-1 p-5 transition-colors" style={{ border: "1px solid var(--color-border-light)", backgroundColor: "var(--color-card-bg)" }}>
          ...
          <pre className="font-mono text-xs leading-[1.7] whitespace-pre" style={{ color: "var(--color-text-dim)" }}>{cobolCode}</pre>
        </div>
        <div className="flex items-center justify-center w-14" style={{ backgroundColor: "var(--color-card-bg)" }}>
          <ArrowRight size={24} className="text-[var(--color-accent)]" />
        </div>
        <div className="flex-1 p-5 transition-colors" style={{ border: "1px solid var(--color-border-light)", backgroundColor: "var(--color-card-bg)" }}>
          <div className="flex items-center gap-2 mb-2">
          ...
          <div className="h-px mb-3" style={{ backgroundColor: "var(--color-border-light)" }} />
          <pre className="font-mono text-xs leading-[1.7] whitespace-pre" style={{ color: "var(--color-code-green)" }}>{javaCode}</pre>
        </div>
      </motion.div>
    </section>
  );
